# Tasmota driver for nextion panels | code by CEu-projects
# based on;
...
# Example Flash
# FlashNextion http://openhab:9090/NSPanel.tft
...
class Nextion : Driver
                    ...
                    for i:0..size(msg_list)-1
                        ...
                        if size(msg) > 0
                            if msg == bytes('000000FFFFFF88FFFFFF')
                                ...
                                var jm = string.format("{\"NextionReceive\":%s}",msg[4..-3].asstring())
    ...
    def installNsPanel()
        self.flash_nextion("http://openhab:9090/NSPanel.tft")
    end
	
	def installNextionPanel()
...
def install_NsPanel()
    tasmota.set_timer(50,/->nextion.installNsPanel())
    tasmota.resp_cmnd_done()
end

def install_NextionPanel()
    tasmota.set_timer(50,/->nextion.installNextionPanel())
    tasmota.resp_cmnd_done()
end
